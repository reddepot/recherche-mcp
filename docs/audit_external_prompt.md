...
> Une **version Gemini-spécifique** existe en parallèle : `docs/audit_gemini_prompt.md` (Vertex AI / multimodalité / Google Search). Ne pas dupliquer ses angles ici.
...
- **Audit ORTHOGONAL** : si tu vois un finding déjà couvert par les 4 voix V1 (les 18 listés) ou par l'audit Gemini parallèle (axes Vertex/multimodalité/Google Search), marque-le « DÉJÀ FIXÉ commit X » ou « TRAITÉ Gemini » et passe au suivant
